...
- A sidecar is a utlity container in the pod and its purpose is to support the main container <br>
**Example:** Setting up configuration, checking for dependencies. Collect the logs and send it to s3 bucket<br>
